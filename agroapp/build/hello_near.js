...
let HelloNear = (_dec = NearBindgen({}), _dec2 = call({}), _dec(_class = (_class2 = class HelloNear {
  hello() {
    return NearPromise.new("intro-to-near.agorapp.testnet").functionCall("get_secret", "", NO_DEPOSIT, GAS);
  }
}, _applyDecoratedDescriptor(_class2.prototype, "hello", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "hello"), _class2.prototype), _class2)) || _class);
function hello() {
  ...
  const _result = _contract.hello(_args);
