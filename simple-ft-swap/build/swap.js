...
let TokenSwap = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec(_class = (_class2 = class TokenSwap {
  balances = new LookupMap("balances");
  ft_on_transfer({
    sender_id,
    amount,
    msg
...
}, _applyDecoratedDescriptor(_class2.prototype, "ft_on_transfer", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_on_transfer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "swap", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "swap"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ft_withdraw", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "ft_withdraw"), _class2.prototype), _class2)) || _class);
function ft_withdraw() {
  const _state = TokenSwap._getState();
  if (!_state && TokenSwap._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = TokenSwap._create();
  if (_state) {
    TokenSwap._reconstruct(_contract, _state);
  }
  const _args = TokenSwap._getArgs();
  const _result = _contract.ft_withdraw(_args);
  TokenSwap._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TokenSwap._serialize(_result, true));
}
function swap() {
  const _state = TokenSwap._getState();
  if (!_state && TokenSwap._requireInit()) {
  ...
  const _args = TokenSwap._getArgs();
  const _result = _contract.swap(_args);
  TokenSwap._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TokenSwap._serialize(_result, true));
}
function ft_on_transfer() {
  ...
  const _args = TokenSwap._getArgs();
  const _result = _contract.ft_on_transfer(_args);
  TokenSwap._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TokenSwap._serialize(_result, true));
}

export { ft_on_transfer, ft_withdraw, swap };
